...
- **Modal Input:** Keystroke meaning is mode-dependent (Normal / Adding / Editing / ConfirmDelete / Help / Detail / DetailOverview / DetailHelp / CommitInput). The status bar always reflects the current mode so the user can recover orientation at a glance.
