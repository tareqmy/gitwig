...
impl Action {
    pub fn from_index(idx: usize) -> Option<Self> {
        match idx {
            ...
            240 => Some(Action::NavUp),
            241 => Some(Action::NavDown),
            242 => Some(Action::NavLeft),
            243 => Some(Action::NavRight),
            244 => Some(Action::NavPageUp),
            245 => Some(Action::NavPageDown),
            246 => Some(Action::NavHome),
            247 => Some(Action::NavEnd),
            248 => Some(Action::NavEnter),
            249 => Some(Action::NavEsc),
            // Detail List Scroll
    ...
    pub fn to_index(self) -> usize {
        match self {
            ...
            Action::NavLeft => 242,
            Action::NavRight => 243,
            Action::NavPageUp => 244,
            Action::NavPageDown => 245,
            Action::NavHome => 246,
            Action::NavEnd => 247,
            Action::NavEnter => 248,
            Action::NavEsc => 249,
...
pub struct NavigationKeybindings {
    pub nav_up: Option<Keybind>,
    pub nav_down: Option<Keybind>,
    pub nav_left: Option<Keybind>,
    pub nav_right: Option<Keybind>,
    pub nav_page_up: Option<Keybind>,
    pub nav_page_down: Option<Keybind>,
    pub nav_home: Option<Keybind>,
    pub nav_end: Option<Keybind>,
    pub nav_enter: Option<Keybind>,
    pub nav_esc: Option<Keybind>,
...
impl KeybindingsConfig {
    pub fn default_config() -> Self {
        Self {
            ...
            navigation: NavigationKeybindings {
                ...
                nav_down: Some(Keybind::new(&["down", "j"], "Generic move down in lists/menus")),
                nav_left: Some(Keybind::new(&["left", "h"], "Generic move left in lists/menus")),
                nav_right: Some(Keybind::new(&["right", "l"], "Generic move right in lists/menus")),
                nav_page_up: Some(Keybind::new(&["pageup"], "Generic page up in lists/menus")),
                nav_page_down: Some(Keybind::new(
                    &["pagedown"],
                    "Generic page down in lists/menus",
                )),
                nav_home: Some(Keybind::new(&["home"], "Generic jump to top in lists/menus")),
                nav_end: Some(Keybind::new(&["end"], "Generic jump to bottom in lists/menus")),
                nav_enter: Some(Keybind::new(&["enter"], "Generic select or confirm")),
                nav_esc: Some(Keybind::new(&["esc", "q"], "Generic cancel or back")),
    ...
    pub fn get_action_keys(&self, action: Action) -> Vec<String> {
        let keys_opt = match action {
            ...
            Action::NavDown => self.navigation.nav_down.as_ref(),
            Action::NavLeft => self.navigation.nav_left.as_ref(),
            Action::NavRight => self.navigation.nav_right.as_ref(),
            Action::NavPageUp => self.navigation.nav_page_up.as_ref(),
            Action::NavPageDown => self.navigation.nav_page_down.as_ref(),
            Action::NavHome => self.navigation.nav_home.as_ref(),
            Action::NavEnd => self.navigation.nav_end.as_ref(),
            Action::NavEnter => self.navigation.nav_enter.as_ref(),
            Action::NavEsc => self.navigation.nav_esc.as_ref(),
    ...
    pub fn update_action_keys(&mut self, action: Action, keys: Vec<String>) {
        ...
        match action {
            ...
            Action::NavDown => self.navigation.nav_down = keybind,
            Action::NavLeft => self.navigation.nav_left = keybind,
            Action::NavRight => self.navigation.nav_right = keybind,
            Action::NavPageUp => self.navigation.nav_page_up = keybind,
            Action::NavPageDown => self.navigation.nav_page_down = keybind,
            Action::NavHome => self.navigation.nav_home = keybind,
            Action::NavEnd => self.navigation.nav_end = keybind,
            Action::NavEnter => self.navigation.nav_enter = keybind,
            Action::NavEsc => self.navigation.nav_esc = keybind,
